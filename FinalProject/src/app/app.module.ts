...
@NgModule({
  ...
  providers: [{provide: ErrorHandler, useClass: IonicErrorHandler},AdminHomeBodyService,WishListService,HomeBodyService,GetIsbn,Authenticate,Search,CookieService,AdalService,{provide: APP_BASE_HREF, useValue: '/'}]
})
